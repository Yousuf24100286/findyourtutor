...
import { H1, H2, P, Subtle, Disabled } from '@/components/Typography';
  ...
  return (
    <div className='flex flex-1 flex-row flex-wrap justify-evenly items-center gap-20'>
      <div className='flex flex-col gap-4 bg-white rounded-lg p-6 text-wrap max-w-80 items-center'>
        ...
        <H1 className='text-prussian-blue'>Parent</H1>
      ...
      <div className='flex flex-col gap-4 bg-white rounded-lg p-6 text-wrap max-w-80 items-center'>
        ...
        <H1 className='text-prussian-blue'>Student</H1>
      ...
      <div className='flex flex-col gap-4 bg-white rounded-lg p-6 text-wrap max-w-80 items-center'>
        ...
        <H1 className='text-prussian-blue'>Tutor</H1>
